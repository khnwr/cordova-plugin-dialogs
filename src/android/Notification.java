...
public class Notification extends CordovaPlugin {
    ...
    public synchronized void alert(final String message, final String title, final String buttonLabel, final CallbackContext callbackContext) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                ...
                AlertDialog.Builder dlg = createDialog(cordova); // new AlertDialog.Builder(cordova.getActivity(), AlertDialog.THEME_HOLO_DARK);
    ...
    public synchronized void activityStart(final String title, final String message) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                notification.spinnerDialog = createProgressDialog(cordova); // new ProgressDialog(cordova.getActivity(), AlertDialog.THEME_HOLO_DARK);
    ...
    public synchronized void progressStart(final String title, final String message) {
        ...
        Runnable runnable = new Runnable() {
            public void run() {
                notification.progressDialog = createProgressDialog(cordova); // new ProgressDialog(cordova.getActivity(), AlertDialog.THEME_HOLO_DARK);
